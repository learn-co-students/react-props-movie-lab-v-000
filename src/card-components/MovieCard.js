  ...
  render() {
    return (
      <div className="movie-card">
        ...
        <CardFront  poster={MovieCard.props.poster} />
        <CardBack  title={MovieCard.props.title} IMDBRating={MovieCard.props.IMDBRating} genres={MovieCard.props.genres} poster={MovieCard.props.poster}/>
      </div>
    )
  }
}
