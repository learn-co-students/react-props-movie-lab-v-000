  ...
  render() {
    ...
    return (
      <div className="movie-card">
        ...
        <CardFront poster={this.props.poster} key={this.props.key}/>
        <CardBack title={this.props.title} genres={this.props.genres} IMDBRating={this.props.IMDBrating} key={this.props.key} />
...
//CardBack: title, genres, rating
//CardFront: movie poster
