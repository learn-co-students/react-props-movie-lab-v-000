  ...
  render() {
    ...
    return (
      <div className="movie-card">
        <CardFront poster={posterMap[this.props.info.poster]}/>
        <CardBack title={this.props.info.title} genres={this.props.info.genres} IMDBRating={this.props.info.IMDBRating} />
      </div>
    )
  }
}
