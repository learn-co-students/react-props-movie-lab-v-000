  ...
  render() {
    return (
      <div className="movie-card">
        ...
        <CardBack title={this.props.content.title} genres={this.props.content.genres.join(", ")} IMDBRating={this.props.content.IMDBRating} />
      </div>
    )
  }
}
...
MovieCard.defaultProps = {
  title: 'Unknown',
  IMDBRating: <h4>No Rating Found</h4>,
  poster: 'default',
